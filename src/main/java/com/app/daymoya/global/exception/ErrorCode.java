...
public enum ErrorCode {
  ...
  AUTH_CODE_EXPIRED(BAD_REQUEST, "AUTH-006", "인증번호가 만료되었거나 존재하지 않습니다. 인증번호를 다시 요청해주세요."),
  ...
  CATEGORY_NAME_DUPLICATED(BAD_REQUEST, "CATEGORY-003", "동일한 이름의 카테고리가 존재합니다."),
  CATEGORY_ID_DUPLICATED(BAD_REQUEST, "CATEGORY-004", "중복된 카테고리 ID가 존재합니다."),
